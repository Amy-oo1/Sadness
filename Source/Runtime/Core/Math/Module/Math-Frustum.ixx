...
namespace Math {
    ...
    export inline Frustum operator* (const OrthogonalTransform& xform, const Frustum& frustum){
        Frustum result {};
    ...
    export inline Frustum operator* (const AffineTransform& xform, const Frustum& frustum){
        Frustum result {};
    ...
    export inline Frustum operator* (const Matrix4x4& mtx, const Frustum& frustum){
        Frustum result {};
