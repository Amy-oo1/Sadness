...
//export template<D3D12_DESCRIPTOR_HEAP_TYPE _Type>
//class DescriptorHandle final : public DeviceChild {
//	static_assert(D3D12_DESCRIPTOR_HEAP_TYPE_NUM_TYPES != _Type, "Invalid Descriptor Heap Type");
...
//	static constexpr D3D12_DESCRIPTOR_HEAP_TYPE DescriptorHeapType = DescriptorHeapTraits<Derived>::DescriptorHeapType;
//protected:
...
//
//		{
//			this->m_HeapDesc.Type = DescriptorHeapTraits<Derived>::DescriptorHeapType;
...
//
//protected:
//	bool HasAvailableSpace(Uint32 Count) { return this->m_DescriptorCount <= Count; }
//
